  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={`
            fixed top-0 left-0 z-50 h-full w-64 bg-blue-700 text-white p-6 
            ...
            <Route
              ...
              element={
                <>
                  ...
                  <p className="text-gray-600 mb-4">Insights and trends from your application usage.</p>
            ...
            <Route
              ...
              element={
                <>
                  ...
                  <p className="text-gray-600 mb-4">Monitoring and detection of unusual patterns.</p>
                  <div className="h-64 bg-gray-100 rounded flex items-center justify-center">
